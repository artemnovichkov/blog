...
In a previous post, we discussed how to [create an MCP server in Swift](https://artemnovichkov.com/blog/creating-mcp-servers-in-swift). If you're new to MCP, I recommend reading it first.
