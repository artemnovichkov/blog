...
description: >-
  Three out-of-box ways to show web content offline. Of course, with SwiftUI
  examples
...
<Callout type="info" emoji="️ℹ️">
  Since iOS 26.0, Apple introduced `WebView` and `WebPage` to simplify web content handling in SwiftUI. You can read more about them in my [new blog post](https://artemnovichkov.com/blog/using-webkit-to-load-web-content-in-swiftui).
</Callout>
...
<Callout type="error" emoji="️🚫">
  Domain=WKErrorDomain Code=1 "An unknown error occurred" UserInfo=\{NSLocalizedDescription=An unknown error occurred\}
</Callout>

<p align="center">
  <img src="https://media.giphy.com/media/S5n7Wkhhw5A2IrfKER/giphy.gif" alt="Alright then, keep your secrets" />
</p>
...
![Example preview](/images/swiftui-offline/example-preview.png)
