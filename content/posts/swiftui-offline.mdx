...
![Initial preview](https://media.giphy.com/media/S5n7Wkhhw5A2IrfKER/giphy.gif){ width=480 height=198 }
...
![Example preview](/images/swiftui-offline/example-preview.png){ width=946 height=1764 }
