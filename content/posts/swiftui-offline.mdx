...
<Callout type="info" emoji="️ℹ️">
  Since iOS 18.4, Apple introduced `WebView` and `WebPage` to simplify web content handling in SwiftUI. You can read more about them in my [new blog post](https://www.artemnovichkov.com/blog/using-webkit-to-load-web-content-in-swiftui).
</Callout>
