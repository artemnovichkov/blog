...
date: '2021-04-25'
categories: swiftui, webkit
author:
  - artem-novichkov
---

<Callout type="info" emoji="️ℹ️">
  Since iOS 26.0, Apple introduced `WebView` and `WebPage` to simplify web content handling in SwiftUI. You can read more about them in my [new blog post](https://www.artemnovichkov.com/blog/using-webkit-to-load-web-content-in-swiftui).
</Callout>
