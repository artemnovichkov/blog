...
<Callout type="info" emoji="️ℹ️">
  If you can't find Views or Modifiers tabs, try to enable Canvas in Editor > Canvas menu or by pressing ⌥ + ⌘ + ⏎.
</Callout>
...
Another way to run it is via command line:
