...
description: Let's try to implement custom popups in SwiftUI
...
<Image
  alt={`Final design`}
  src={`/images/custom-popups-in-swiftui/design.png`}
  width={414}
  height={896}
/>
...
<Image
  alt={`NamePopupView`}
  src={`/images/custom-popups-in-swiftui/popup-1.png`}
  width={1044}
  height={650}
/>
...
<Image
  alt={`Popup with extra Safe Area insets`}
  src={`/images/custom-popups-in-swiftui/popup-2.png`}
  width={946}
  height={1764}
/>
...
<Image
  alt={`Popup with ignoring Safe Area insets`}
  src={`/images/custom-popups-in-swiftui/popup-3.png`}
  width={946}
  height={1764}
/>
...
<Image
  alt={`Popup with keyboard avoidance`}
  src={`/images/custom-popups-in-swiftui/popup-4.png`}
  width={946}
  height={1764}
/>
...
<Image
  alt={`Popup with extra Safe Area insets`}
  src={`/images/custom-popups-in-swiftui/final.gif`}
  width={600}
  height={1298}
/>
