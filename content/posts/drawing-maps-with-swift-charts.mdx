...
I hope you enjoyed this example and will try to draw your own maps. As usual you can find the final project on [Github](http://x.com/iosartem). If you have any questions or suggestions, feel free to share them on [X](http://x.com/iosartem). Thanks for reading!