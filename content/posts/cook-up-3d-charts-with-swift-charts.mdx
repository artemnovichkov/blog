...
WWDC 2025 introduced new changes in SwiftUI, and one of great additions is Chart3D. With this new API, you can now create interactive and customizable 3D charts directly in SwiftUI — no third-party libraries or complex SceneKit setups required.
