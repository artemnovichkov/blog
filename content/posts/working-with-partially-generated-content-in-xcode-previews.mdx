...
description: Learn how to use Foundation Models guided generation in Xcode previews
cover: /images/working-with-partially-generated-content-in-xcode-previews/cover.png
date: '2025-07-28'
categories: swiftui, foundation-models, xcode, wwdc25
author:
  - artem-novichkov
---
...
<div className="flex justify-center">
  <img src="/images/working-with-partially-generated-content-in-xcode-previews/content-preview.png" alt="Content" style={{maxWidth: "100%"}} />
</div>
