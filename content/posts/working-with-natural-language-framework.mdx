...
In a [previous post](https://artemnovichkov.com/blog/mastering-text-editor-in-swiftui) we explored the features of `TextEditor` in SwiftUI. In this article, we'll dive into the Natural Language framework and how to use it to analyze text in real time.
