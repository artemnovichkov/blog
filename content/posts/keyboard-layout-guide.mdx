...
description: Working with UIKeyboardLayoutGuide in iOS 15
...
<div className="video">
  <iframe src="//www.youtube.com/embed/C2aWOSRhTOM" frameBorder="0" allowFullScreen className="video"></iframe>
</div>
