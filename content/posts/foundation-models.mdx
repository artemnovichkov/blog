---
title: Exploring Foundation Models framework
description: Learn how to use Foundation models in iOS apps
cover: /images/foundation-models/cover.png
date: '2025-06-29'
author:
  - artem-novichkov
---
...
![Availability](/images/foundation-models/availability.png)
...
- `guardrails`. Controls the guardrails setting for prompt and response filtering. For now, it used by default and can't be disabled;
...
![Input](/images/foundation-models/input.png)
...
![Apple Health](/images/foundation-models/apple-health.png)
...
![Final result](/images/foundation-models/final-result.png)
...
You can find the complete code in the [GitHub repository](https://github.com/artemnovichkov/foundation-models-example). Thanks for reading!
