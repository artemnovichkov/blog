...
![Initial view](/images/remove-background-from-image-in-swiftui/final-view.png){ width=685 height=1366 }
...
![Hide background of the image](/images/remove-background-from-image-in-swiftui/background-animation.gif){ width=500 height=1084 }
...
![Scale the sticker image](/images/remove-background-from-image-in-swiftui/sticker-animation.gif){ width=500 height=1084 }
...
![Scale the sticker image](/images/remove-background-from-image-in-swiftui/final-animation.gif){ width=500 height=1084 }
