              ...
              <li key={item.id}>
                <a
                  ...
                  className={`block border-l-2 py-1 pl-3 text-sm transition-colors duration-150 ease-out ${
                    isActive
                      ? "-ml-px border-zinc-900 font-medium text-zinc-900 dark:border-gray-100 dark:text-gray-100"
                      : "-ml-px border-transparent text-zinc-500 hover:text-zinc-900 dark:text-gray-400 dark:hover:text-gray-100"
                  }`}
                >
                  {item.title}
                </a>
