...
const Callout: React.FC<CalloutProps> = ({ type = 'info', emoji, children }) => {
    ...
    const typeStyles: Record<string, string> = {
        ...
        warning: 'bg-yellow-50 border-yellow-100 dark:bg-yellow-700/30 dark:border-yellow-200/30 border',
        error: 'bg-red-100 border-red-200 dark:bg-red-900/30 dark:border-red-200/30 border',
    };
